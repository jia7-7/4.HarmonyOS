...
const int32_t MEDIA_IC_DEFAULT = 0x0100000a;
const int32_t MEDIA_IC_ICON = 0x0100000b;
const int32_t MEDIA_IC_OK = 0x0100000c;
const int32_t MEDIA_LAYERED_IMAGE = 0x01000004;
const int32_t MEDIA_STARTICON = 0x0100000d;
